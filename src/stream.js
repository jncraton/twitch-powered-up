...
function start () {
  ...
  const cmdString = `ffmpeg -f lavfi -i anullsrc=channel_layout=stereo:sample_rate=44100 -f v4l2 -video_size 640x480 -i ${DISPLAY_DEVICE} -vcodec libx264 -r ${FRAMERATE} -vf "crop=640:360:0:60" -g 30 -pix_fmt yuv420p -preset ${QUALITY} -f flv "rtmp://${INGEST_SERVER}.twitch.tv/app/${STREAM_KEY}"`
