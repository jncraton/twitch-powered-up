...
function main() {
  ...
  let cmdString = `ffmpeg -f v4l2 -video_size 640x360 -i ${DISPLAY_DEVICE} -vcodec libx264 -r ${FRAMERATE} -pix_fmt yuv420p -preset ${QUALITY} -f flv \"rtmp://${INGEST_SERVER}.twitch.tv/app/${STREAM_KEY}\"`
